    ...
    fn settings_view(&self, _cx: &mut App) -> Option<ProviderSettingsView> {
        ...
        Some(ProviderSettingsView::SubPage(
            ...
            .description(InlineDescription::Text(
                "To use OpenCode models in Fanta, you need an API key.".into(),
            )),
        ))
    }
}
...
impl Render for ConfigurationView {
    fn render(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let api_key_section = v_flex()
            ...
            .child(Label::new(
                "To use OpenCode models in Fanta, you need an API key:",
            ).color(Color::Muted))
            .child(
                List::new()
                    .child(
            ...
            .child(
                Label::new(format!(
                    "You can also set the {API_KEY_ENV_VAR_NAME} environment variable and restart Fanta."
                ))
