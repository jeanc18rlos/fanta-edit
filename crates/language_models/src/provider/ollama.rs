...
impl ConfigurationView {
        ...
        v_flex()
            ...
            .child(
                List::new()
                    ...
                    .child(
                        ListBulletItem::new("Click 'Connect' below to start using Ollama in Fanta")
    ...
    fn render_api_key_editor(&self, cx: &Context<Self>) -> impl IntoElement {
        ...
        v_flex()
          ...
          .child(
              Label::new(
                  format!("You can also set the {API_KEY_ENV_VAR_NAME} environment variable and restart Fanta.")
              )
