//! On-disk formats for Fantaisa: the `.fant` container and the git-native
//! project tree.
//!
...
pub use project::{
    ProjectManifest, export_fant_snapshot, import_fant_snapshot, is_project_dir, read_project_tree,
    scaffold_project_tree, write_project_tree,
};
