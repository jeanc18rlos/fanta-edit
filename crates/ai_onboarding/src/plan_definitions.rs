...
/// Centralized definitions for the hosted AI plans
...
impl PlanDefinitions {
    ...
    pub fn sign_in_upsell(&self) -> impl IntoElement {
        List::new()
            ...
            .child(ListBulletItem::new("$20 of tokens in the Fanta agent"))
    ...
    pub fn pro_plan(&self) -> impl IntoElement {
        List::new()
            .child(ListBulletItem::new("$5 of tokens in the Fanta agent"))
    ...
    pub fn vip_plan(&self) -> impl IntoElement {
        List::new()
            .child(ListBulletItem::new("Unlimited edit predictions"))
            .child(ListBulletItem::new("Tokens in the Fanta agent"))
    }

    pub fn student_plan(&self) -> impl IntoElement {
        List::new()
            .child(ListBulletItem::new("Unlimited edit predictions"))
            .child(ListBulletItem::new("$10 of tokens in the Fanta agent"))
            .child(ListBulletItem::new(
