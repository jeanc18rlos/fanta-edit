...
use fanta_doc::{Bounds, CanvasNode, Fill, NodeData, Operation, PathData, Transform2D, VectorNode};
use glam::DVec2;
        ...
        match p {
            ...
            PointerEvent::Release {
                ...
                if rect.width() > 0.0 && rect.height() > 0.0 {
                    // Use local rect at origin for path; set transform for place rebase.
                    let local_rect = Bounds::from_xywh(0.0, 0.0, rect.width(), rect.height());
                    let verts = polygon_vertices(local_rect, self.sides);
                    ...
                    node.transform = Transform2D::translation(rect.min_x, rect.min_y);
