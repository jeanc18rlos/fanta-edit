        ...
        match p {
            ...
            PointerEvent::Release {
                ...
                if rect.width() > 0.0 && rect.height() > 0.0 {
                    ...
                    // Path relative to local origin; position via node transform.
                    let path = PathData::ellipse(0.0, 0.0, rx, ry);
                    ...
                    // Position via transform (path is centered at 0) so place_new
                    // can rebase under parent.
                    node.transform = Transform2D::translation(cx, cy);
