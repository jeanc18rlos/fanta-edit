        ...
        match p {
            ...
            PointerEvent::Release {
                ...
                if rect.width() > 0.0 && rect.height() > 0.0 {
                    // Create with local geometry at origin; set transform to the
                    // desired world position so place_new_node_on_active_page can
                    // correctly rebase it under the active page/scope (fixes
                    // new shapes rendering invisible/offscreen after reparent).
