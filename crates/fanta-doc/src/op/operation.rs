...
use crate::id::{ComponentId, ComponentPropId, ModeId, NodeId, VariableCollectionId, VariableId};
...
pub enum Operation {
    ...
    SetOpacity { id: NodeId, old: f32, new: f32 },
    ...
    /// action, or transition). Stores both prior and new for a clean inverse.
    SetReaction {
        node: NodeId,
        index: usize,
        old: Reaction,
