...
pub fn compile(manifest: bool) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let (icon_filename, product_name) = match channel {
        "stable" => ("app-icon.ico", "Fanta"),
        "preview" => ("app-icon-preview.ico", "Fanta Preview"),
        "nightly" => ("app-icon-nightly.ico", "Fanta Nightly"),
        _ => ("app-icon-dev.ico", "Fanta Dev"),
    };
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "CompanyName", "Fanta\0"
            VALUE "LegalCopyright", "Copyright 2022 - 2026 Fanta\0"
        END
    END
    BLOCK "VarFileInfo"
    BEGIN
