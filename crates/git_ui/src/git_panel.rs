...
pub struct GitPanel {
    ...
    // Populated by `load_local_committer` for the collaborative co-author list, which
    // was removed along with the `call` crate; kept because `commit_modal` still primes it.
    #[allow(dead_code)]
