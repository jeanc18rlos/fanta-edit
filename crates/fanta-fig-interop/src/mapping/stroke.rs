...
pub(crate) fn group_with_optional_clip(
    ...
    GroupNode {
        ...
        // Component masters / instance-fallback frames honor authored overflow
        // exactly like FRAME (a scrolling list inside a component master must
        // scroll in its instances too).
        scroll_direction: super::read_scroll_direction(change),
        scroll_offset: super::read_scroll_offset(change),
    }
}
