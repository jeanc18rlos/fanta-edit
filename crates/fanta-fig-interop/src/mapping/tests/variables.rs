...
fn variable_set_maps_to_collection_with_modes_and_variable_values() {
    ...
    let fig = doc_from(vec![
        o(
            ...
            vec![
                ("guid", guid(0, 1)),
                ("type", KiwiValue::Enum("VARIABLE_SET".to_owned())),
        ...
        o(
            ...
            vec![
                ("guid", guid(0, 2)),
                ("type", KiwiValue::Enum("VARIABLE".to_owned())),
                ("name", KiwiValue::String("bg".to_owned())),
                ("variableSetID", variable_id(0, 1)),
                ("variableResolvedType", KiwiValue::Enum("COLOR".to_owned())),
                (
                    "variableDataValues",
                    o(
                        "VariableDataValues",
    ...
    let fig = doc_from(vec![
        ...
        o(
            ...
            vec![
                ...
                ("variableSetID", variable_id(0, 1)),
                ("variableResolvedType", KiwiValue::Enum("FLOAT".to_owned())),
                (
                    "variableDataValues",
                    o(
                        "VariableDataValues",
                    ...
                    vec![(
                        ...
                        KiwiValue::Array(vec![o(
                            ...
                            vec![
                                ...
                                ("variableField", KiwiValue::Enum("CORNER_RADIUS".to_owned())),
                            ],
                        )]),
                    )],
                ),
