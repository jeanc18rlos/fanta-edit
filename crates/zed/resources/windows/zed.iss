...
AppPublisher=Fanta
AppPublisherURL=https://fanta.dev/
AppSupportURL=https://fanta.dev/
AppUpdatesURL=https://fanta.dev/
...
[Files]
Source: "{#ResourcesDir}\Fanta.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Classes\zed\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Fanta.exe,1"
Root: HKCU; Subkey: "Software\Classes\zed\shell\open\command"; ValueType: "string"; ValueData: """{app}\Fanta.exe"" ""%1"""
