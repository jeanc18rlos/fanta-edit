...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Fanta Dev Instance Running",
        ReleaseChannel::Nightly => "Fanta Nightly Instance Running",
        ReleaseChannel::Preview => "Fanta Preview Instance Running",
        ReleaseChannel::Stable => "Fanta Stable Instance Running",
    }
}
