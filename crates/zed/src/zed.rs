...
/// Loads a bundled keymap, tolerating bindings that reference actions which are
/// not registered in this build. Fanta unlinks many of the crates whose actions
/// the bundled keymaps still bind, and the strict loader treats a single
/// unregistered action as a whole-file failure, so the strict loader would abort
/// startup here.
