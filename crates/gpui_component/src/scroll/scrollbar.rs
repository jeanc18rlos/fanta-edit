...
impl ScrollbarHandle for ScrollHandle {
    ...
    fn content_size(&self) -> Size<Pixels> {
        ...
        gpui::size(max_offset.x, max_offset.y) + self.bounds().size
    }
}
...
impl ScrollbarHandle for UniformListScrollHandle {
    ...
    fn content_size(&self) -> Size<Pixels> {
        ...
        gpui::size(max_offset.x, max_offset.y) + base_handle.bounds().size
    }
}
...
impl ScrollbarHandle for ListState {
    ...
    fn content_size(&self) -> Size<Pixels> {
        ...
        self.viewport_bounds().size + gpui::size(max_offset.x, max_offset.y)
    }
